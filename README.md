...
This chapter covers the basics of the XMPP protocol. It also shows how to use XMPP in the **actuator**, **sensor** and **controller** projects, each running on separate Raspberry Pis or Raspberry Pi 2s.
